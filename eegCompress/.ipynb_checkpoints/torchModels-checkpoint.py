...
class conv1d(torch.nn.Module):
    def __init__(self, nChannel, numSampleInput):
        ...
        self.conv1 = torch.nn.Conv1d(in_channels=nChannel, out_channels=100, kernel_size=3)
        self.conv2 = torch.nn.Conv1d(in_channels=100, out_channels=100, kernel_size=3)
        self.linear1 = torch.nn.Linear(1600,80)
        self.linear2 = torch.nn.Linear(80,nChannel)
